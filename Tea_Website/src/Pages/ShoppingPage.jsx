        ...
        return (
            ...
            <section id="shopping-section">
                ...
                <div id="catalog-of-items">
                    {teaItems?.map((item) => <ProductCard id={item.id} name={item.name} price={item.price} description = {item.description} picture = {item.image_url} setCounter={setCount} counter={count} setUsersCurrentItems={setUsersCurrentItems} usersCurrentItems={usersCurrentItems} />)}
                </div>
                ...
                <p>
                    {usersCurrentItems[0]?.quantity}
                </p>
                </footer>

                <PopupCard popupStatus={popup} changeStatus={setPopup} numberOfItems={count} usersCurrentItems={usersCurrentItems} />
